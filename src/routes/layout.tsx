...
const SocialItem = component$<{ url: string; svgPath: JSXChildren; hoverColor: string }>(
  ({ url, svgPath, hoverColor }) => (
    <li class={menuItemCtn}>
...
const SocialMenu = component$(() => (
  <ul class={socialMenuCtn}>
    <SocialItem
      url="https://www.linkedin.com/in/linkfang/"
      svgPath={
