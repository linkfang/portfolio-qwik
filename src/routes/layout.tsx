...
// const SocialItem = component$<{ url: string; hoverColor: string }>(({ url, hoverColor }) => (
//   <li class={menuItemCtn}>
...
//         height="23"
//         viewBox="0 0 16 16"
//         class={css({ fill: '#6b7280', transition: 'all 0.3s ease-out', '&:hover': { fill: hoverColor } })}
//       >
//         <Slot />
//       </svg>
//     </a>
